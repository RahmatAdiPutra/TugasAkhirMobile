...
export class ManageInfo {
  ...
  public infoTanggal            : any;
  public infoPenjelasan         : any;
  public infoFoto         : any;
  ...
  selectEntry(item)
  {
    ...
    this.infoTanggal      = item.tanggal;
    this.infoPenjelasan   = item.penjelasan;
    this.infoFoto   = item.foto;
  ...
  createEntry(judul, tanggal, penjelasan, foto)
  {
    ...
    let body     : string   = "key=create&judul=" + judul + "&tanggal=" + tanggal + "&penjelasan=" + penjelasan + "&foto=" + foto,
        ...
        url      : any      = this.alamatURL.getUrl() + "manageInfo.php";
  ...
  {
    this.alamatURL = new Server();
    let judul      : string = this.infoJudul,
